<template>
    <div class="divider">CREAR NUEVA CONFIGURACION</div>
    ...
    <div class="grid grid-cols-2 gap-x-11 mt-10 bg-white shadow-lg p-4 rounded-lg">
        ...
        <div class="col-span-1 flex justify-center w-full mt-6">
            ...
            <div class=" w-1/4 flex flex-col items-center space-y-6 justify-center">
               <div>
                    <img v-if="!url" src="@/assets/img-holder.png" alt="holder" class="w-32">    
...
const save = async () => {
    ...
    try {
        ...
        const { data: { data } } = await condominiumApi.post('settings',formData)
        ...
        setTimeout(() => {
            ...
            toast.success('Configuracion creada con exito !!', {
